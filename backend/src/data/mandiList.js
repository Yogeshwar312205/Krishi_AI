 ...
 * Extracted from mandiGeo.js for use in buyer posting forms and location selection.
 * 
 * Sorted by district for easier navigation, includes major markets from:
 * - MARKET_COORDS: High-volume APMC yards with exact coordinates
 * - TOWN_COORDS: Taluka-level markets
 * - DISTRICT_COORDS: District headquarters
 */
...
const MANDIS_BY_DISTRICT = MAHARASHTRA_MANDIS.reduce((acc, mandi) => {
